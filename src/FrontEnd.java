...
public class FrontEnd extends Application {
    ...
    private void launchGame() {
        ...
        Button p1InsuranceButton = new Button("Insurance");
        p1InsuranceButton.setTextAlignment(TextAlignment.CENTER);
        p1InsuranceButton.setLayoutX(90);
        p1InsuranceButton.setLayoutY(535);
        p1InsuranceButton.setPrefWidth(120);
        p1InsuranceButton.setVisible(false);
        Button p2InsuranceButton = new Button("Insurance");
        p2InsuranceButton.setTextAlignment(TextAlignment.CENTER);
        p2InsuranceButton.setLayoutX(390);
        p2InsuranceButton.setLayoutY(535);
        p2InsuranceButton.setPrefWidth(120);
        p2InsuranceButton.setVisible(false);
        Button p3InsuranceButton = new Button("Insurance");
        p3InsuranceButton.setTextAlignment(TextAlignment.CENTER);
        p3InsuranceButton.setLayoutX(690);
        p3InsuranceButton.setLayoutY(535);
        p3InsuranceButton.setPrefWidth(120);
        p3InsuranceButton.setVisible(false);
        Button p4InsuranceButton = new Button("Insurance");
        p4InsuranceButton.setTextAlignment(TextAlignment.CENTER);
        p4InsuranceButton.setLayoutX(990);
        p4InsuranceButton.setLayoutY(535);
        p4InsuranceButton.setPrefWidth(120);
        p4InsuranceButton.setVisible(false);
        group.getChildren().addAll(p1InsuranceButton, p2InsuranceButton, p3InsuranceButton, p4InsuranceButton);
        ...
        dealButton.setOnAction((event) -> {
            try {
                ...
                p1InsuranceButton.setVisible(true);
                p2InsuranceButton.setVisible(true);
                p3InsuranceButton.setVisible(true);
                p4InsuranceButton.setVisible(true);
